...
import com.snebot.fbmoll.view.ConvolutionMatrixView;
...
public class ControlPanel extends JPanel {
    ...
    private ArrayList<ConvolutionData> convolutionMatrixData = new ArrayList<>();
    ...
    private void setup() {
        ...
        for (ConvolutionData data : convolutionMatrixData) comboBox.addItem(data.getName());
    ...
    public void didSelectConvolution() {
        ...
        matrixView.setMatrix(data.getMatrix());
        kTextField.setText(String.valueOf(data.getK()));
    }

    public void didPressApplyButton() {
        if (delegate == null || sourceField == null) return;
        delegate.didApplyChanges(sourceField.getText(), getConvolutionData());
    }
